...
public final class ApplicationMojosTest {
	@Parameter
	public String goal;
	...
	public static Collection<Object[]> data() {
		...
		Object[][] data = new Object[][] { { "list-html5-applications" },
				...
				{ "get-html5-application" },
				{ "create-html5-application-role-assignments" },
				{ "start-html5-application" }, { "get-html5-application" },
				{ "restart-html5-application" }, { "get-html5-application" },
				{ "stop-html5-application" },
				{ "create-html5-subscription-candidate" },
				{ "create-html5-subscription" },
				{ "delete-html5-subscription" },
				{ "delete-html5-subscription-candidate" },
